...
import { ShoppingCart, User, Search, Zap, Package, Tag, UserCheck, Laptop, Shirt, Home, Palette } from 'lucide-react';
import './App.css'; 
...
const CATEGORIES = [
  ...
  { id: 3, name: 'Home Goods', icon: <Home size={32} /> },
    ...
    <nav className="navbar">
      <div className="navbar-content">
        <div className="nav-left">
          <div className="nav-logo" onClick={() => setCurrentPage('front')}>
